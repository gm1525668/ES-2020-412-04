...
def test_hotel_list():
    ...
    flight2 = Flights(2, 'BRU', num_passengers, 20)
    flight3 = Flights(3, 'MRS', num_passengers, 30)
    flight4 = Flights(4, 'BCN', num_passengers, 50)
...
def test_recalculate_price_trip_if_add_remove_hotel():
    ...
    flight2 = Flights(2, 'BRU', num_passengers, 20)
    flight3 = Flights(3, 'MRS', num_passengers, 30)
    flight4 = Flights(5, 'BCN', num_passengers, 50)
...
class testReserveHotel(unittest.TestCase):
    ...
    def test_reserve_hotel(self, mock_Booking):  # se reserva
        num_passengers = 2
        flight1 = Flights(1, 'BRE', num_passengers, 10)
        flight2 = Flights(2, 'BRU', num_passengers, 20)
        flight3 = Flights(3, 'MRS', num_passengers, 30)
...
def test_calculate_price():
    ...
    calculado = trip.calc_price()

    result=450*1.16
    assert trip.price == result
    assert calculado['trip_without_iva'] == result/1.16
